...
/// A labeled group of category icons, used to render the picker in titled
/// sections. Every entry is a real file bundled under assets/categories/
/// (the whole folder is registered in pubspec).
class IconCategoryGroup {
  final String label;
  final List<String> icons;
  const IconCategoryGroup(this.label, this.icons);
}

const List<IconCategoryGroup> categoryIconGroups = [
  IconCategoryGroup('Money & Income', [
  ...
  IconCategoryGroup('Bills & Recurring', [
  ...
  IconCategoryGroup('Shopping & Personal Care', [
  ...
  IconCategoryGroup('Home & Utilities', [
  ...
  IconCategoryGroup('Health & Safety', [
  ...
  IconCategoryGroup('Entertainment & Media', [
  ...
  IconCategoryGroup('Sports & Games', [
  ...
  IconCategoryGroup('Education, Work & Tech', [
  ...
  IconCategoryGroup('Travel & Outdoors', [
  ...
  IconCategoryGroup('Nature & Weather', [
...
/// Flat list of every picker icon, derived from the groups. Kept for the
/// default-icon selection and any code that treats icons as one list.
final List<String> categoryIcons = [
  for (final group in categoryIconGroups) ...group.icons,
];
